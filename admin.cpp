...
//հեռախոսահամարները գցում է phone վեկտորի մեջ, փակում է ֆայլը,
...
void Admin::start()
{
    ...
    if (!fin.is_open()) {
        ...
        while (std::getline(fin, line)) {
			data.push_back(line);
            Contact obj = string_to_Contact(line);
...
void Admin::show_all_contacts()
{
    ...
    std::cout << "|               |                |                |                  |" << std::endl;
    std::cout << "|     name      |     surname    |  phone number  |     address      |" << std::endl;
    std::cout << "|_______________|________________|________________|__________________|" << std::endl;
    std::cout << "|               |                |                |                  |" << std::endl;
    Contact obj;
    for (int i{}; i < data.size(); ++i) {
        obj = string_to_Contact(data[i]);
        std::cout << "|" << obj.contact_to_short_string() << std::endl;
    }
    std::cout << "|_______________|________________|________________|__________________|" << std::endl;
    std::cout << std::endl;
    show_main_menu();
...
bool Admin::check_name(std::string& name) const
{
    ...
    if (name.length() > 14) {
        std::cout << std::endl << "The length of the entered name must be less than 15. Please enter a shorter name" << std::endl;
        return false;
    } 
...
bool Admin::check_surname(std::string& surname) const
{
    ...
    if (surname.length() > 14) {
        std::cout << std::endl << "The length of the entered surname must be less than 15. Please enter a shorter surname" << std::endl;
        return false;
    } 
...
bool Admin::check_phone_number(std::string& phone_number) const
{
    ...
    if (phone_number.length() > 14) {
        std::cout << std::endl << "The length of the entered number must be less than 15. Please enter a shorter number" << std::endl;
        return false;
    }
...
bool Admin::check_address(std::string& address) const
{
    ...
    if (address.length() > 15) {
        std::cout << std::endl << "The length of the entered address must be less than 16. Please enter a shorter address" << std::endl;
        return false;
    }
...
void Admin::show_by_surname() const
{
...
void Admin::show_by_phone_number() const
{
...
void Admin::show_by_address() const
{
